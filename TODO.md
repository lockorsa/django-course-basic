...
1 Вывести счетчики корзины в главное меню 
2 +
3 Сделать слаг маршрут для товаров
4 Добавить декораторы @login_required к контроллерам
* Настроить редиректы в контроллерах
* прописать логин страницу в сеттингах
5 уточнить
6 + 